...
from show.guests.personas.architectures import ARCHITECTURES
from show.guests.personas.registry import make_guest, make_guest_with_architecture
from show.guests.personas.trace import (
    ArchitectureTrace,
    build_pipeline,
    export_traces_json,
    show_state_snapshot,
...
from show.memory.state import initial_show_state
